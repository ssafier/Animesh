...
parseAnimationData(list data) {
  llSay(0,"data "+llDumpList2String(data,","));
  ...
  llSay(0, a1+" "+a2);
  if (me == m) {
    targetAnimation = parseExpression(a2);
    currentAnimation = parseExpression(a1);
  } else {
    targetAnimation = parseExpression(a1);
    currentAnimation = parseExpression(a2);
  }
}
